...
with DAG (
    ...
    csv_jla = csv(filename='', file_separation='Comma')
    to_key_value_24z = to_key_value(data='', fixed_columns='', measurement_columns='')
    harmonize_s5x = harmonize(data='', mappings='', adhoc_harmonization='False')
